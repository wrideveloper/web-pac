...
<body>
  ...
  <header>
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-12 margin-30 wow fadeIn" data-wow-delay="0.6s">
              <div class="col-lg-6 col-sm-12 padding border">
                <h2>Tentang PAC</h2>
    ...
    <section id="timeline" style="padding: 50px">
      <div class="container">
       <div class="row">
        <div class="col-md-12">
          ...
          <ul class="timeline">
				<li>
					<a target="_blank" href="https://www.totoprayogo.com/#">Pendaftaran</a>
					<p>Pendaftaran dibuka mulai <b>1 September 2018 - 30 September 2018</b></p>
				</li>
				<li>
					<a href="#">Babak Penyisihan</a>
      ...
      <!--hadiah-->
      <section id="hadiah" class="pad-sm">
        <div class="container">
          <div class="row margin-40">
            <div class="col-sm-8 col-sm-offset-2 text-center wow fadeInUp" data-wow-delay="0.2s">
